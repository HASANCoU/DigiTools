...
const WorkFlow = () => {
    return (
        <div className=' bg-linear-to-r from-purple-600 via-purple-800 to-purple-900 py-30 text-white'>
            ...
            <ul className='flex justify-center list-disc space-x-8 text-[16px]'>
